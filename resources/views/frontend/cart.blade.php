    ...
    <div class="container">
      <div class="row no-gutters slider-text align-items-end justify-content-center">
        <div class="col-md-9 ftco-animate mb-5 text-center">
            <p class="breadcrumbs mb-0"><span class="mr-2"><a href="{{route('f.home')}}">Home <i class="fa fa-chevron-right"></i></a></span> <span><a href="{{route('cart.index')}}">{{$title}} <i class="fa fa-chevron-right"></i></a></span> <span>
...
<section class="ftco-section">
    ...
    <p
     class="breadcrumbs mb-0">
        <span class="mr-2"><h4>Product Number:  {{count($cart)}} </h4> </span>
</p></div></div>
    <div class="container">
        <div class="row">
                        ...
                        <tr class="alert" role="alert">
                            ...
                            <td class="quantity">
                                <div  class="input-group" >
                                    <input type="text"  name="soluongmua[{{$id}}]" value="{{$item['soluongmua']}}" class="quantity form-control input-number"
                                    min="1" max="100">
                                </div>
                            ...
                            <td>
                                <a id="checkbox"onclick="return confirm('bạn có chắc muốn xóa sp ko')" href="{{route('cart.del',[$id])}}"  >
